...
import { SpecializationsTable } from "./specalizationTable";

const Specalizations: React.FC = () => {
  ...
  useEffect(() => {
    if (specData) {
      const totalPages = Math.ceil(specData.count / pagination.pageSize);
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 space-y-6 transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-gray-600">
              We couldn't retrieve your specalization data. This is likely a
              temporary issue.
            </p>
          </div>
          ...
          <div className="bg-red-50 rounded-lg p-4 text-sm text-red-700 flex items-center space-x-3">
            ...
            <span>Error: Unable to fetch specalization data from the server.</span>
          </div>
    ...
    <>
      ...
      <div className="bg-white rounded-lg p-5">
        <div className="flex justify-between">
          <span className="text-xl font-bold">Specializations</span>

          <Link to="/specalization/add/">
            <Button className="flex text-white rounded-md bg-blue-700 hover:bg-blue-400">
              ...
              <span>Add specializations</span>
            </Button>
          </Link>
        </div>
        <SpecializationsTable
          doctors={specData?.results as any}
