...
import { useGetDoctorsQuery } from "@/services/doctors/doctor.service";
...
const Doctors: React.FC = () => {
  ...
  useEffect(() => {
    if (doctors) {
      const totalPages = Math.ceil(doctors.count / pagination.pageSize);
  ...
  const breadcrumbs = [{ label: "Home", path: "/" }, { label: "Doctors" }];
