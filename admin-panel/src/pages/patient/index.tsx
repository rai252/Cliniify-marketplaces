...
import { useGetPatientsQuery } from "@/services/patients/patient.service";
...
const Patients: React.FC = () => {
  ...
  useEffect(() => {
    if (patientData) {
      const totalPages = Math.ceil(patientData.count / pagination.pageSize);
  ...
  const breadcrumbs = [{ label: "Home", path: "/" }, { label: "Patients" }];
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg p-5">
        ...
        <PatientTable
          patients={patientData?.results as any}
